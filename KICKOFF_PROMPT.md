# KICKOFF — первое сообщение для агента-исполнителя (Claude Code)

> Скопируй текст ниже в первое сообщение сессии Claude Code (или сохрани как CLAUDE.md-приложение).

---

Ты — агент-исполнитель проекта **Mimir Composite Pipeline**: DCC-driven composite asset system
