> Status: REFERENCE · Research (2026-09-01) · Not normative: §2 описывает состояние плагина на `813dd70` до программы R, §3.5 — черновой порядок срезов. Норматив — `docs/16_recipe_model.md`, программа срезов — `KICKOFF_PROMPT.md` §5.
