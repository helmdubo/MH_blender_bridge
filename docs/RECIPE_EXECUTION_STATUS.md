...
| R2a | IN PROGRESS (близнец) | разбит на два PR: **R2a-1** фазовое разделение resolver'а — MERGED #79 (квитанция `docs/receipts/recipe_r2a_phases.md`); **R2a-2** `FMHCompiledRecipe` + `RecipeShadowParityTest` — IN PROGRESS, ветка `recipe/r2a-compiled-recipe` |
| R2b | PLANNED | — |
| R2c | PLANNED | — |
| R3 | PLANNED | — |
| R4 | PLANNED | — |
