...
| R5-F | IN PROGRESS (близнец) | lifecycle-фиксы по аудиту 2026-09-05: rows/leaf-array sync после миграции бакета, Undo во время Edit завершает сессию, `MigrateBucket` сохраняет placement policy, pool-актор виден в Game View; квитанция `docs/receipts/recipe_r5f.md` |
