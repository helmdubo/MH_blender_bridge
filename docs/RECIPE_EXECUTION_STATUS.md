...
| R3b | IN REVIEW (внешний исполнитель; приёмка близнеца) | PR #108, ветка `codex/recipe-r3b-resource-reconcile`, коммит `c51f0cc` («Implement R3b resource reconciliation and record bounded decisions»); OPEN-R3B-1 закрыт близнецом (вариант 1, `fc08ca1`); близнец: 202/202 на generic-хосте; квитанция `docs/receipts/recipe_r3b.md`; полевой замер реимпорта NOT RUN |
