...
| R2c | IN REVIEW (внешний исполнитель) | proof cache и точки выхода реализованы в `e55a049`; PR #88; квитанция `docs/receipts/recipe_r2c.md`; merge — только после проверки близнеца |
| R3 | PLANNED | — |
| R4 | PLANNED | — |
| R5 | PLANNED | — |
| R6 | PLANNED | — |
