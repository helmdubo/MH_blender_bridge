...
# LOCAL_EDIT/CONFLICT are Ledger-only (D25): valid flags of the report format,
# but expected_diffs (bundle-vs-bundle) may never contain them.
RESOURCE_FLAGS = {"CREATE", "REMOVE", "RENAME", "MOVE", "UPDATE_GEOMETRY",
