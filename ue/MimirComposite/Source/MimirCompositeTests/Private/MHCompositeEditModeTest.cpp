...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
    FMHSingleEditBackendSettingsTest,
    "Mimir.V5.Composite.EditMode.SingleBackendSettings",
    EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FMHSingleEditBackendSettingsTest::RunTest(const FString& Parameters)
{
    return TestNull(TEXT("project config cannot reactivate the retired actor-handle backend"),
        UMHCompositeSettings::StaticClass()->FindPropertyByName(TEXT("bCompositeEditModeV2")));
}
...
bool FMHEditModeSaveCancelTest::RunTest(const FString& Parameters)
{
    ...
    // Dirty: explicit Cancel discards immediately.
